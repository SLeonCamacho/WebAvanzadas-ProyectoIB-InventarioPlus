      ...
      <div className="p-4">
        {activeTab === 0 && (
          <div>
            <h2>Create</h2>
            <form>
              {/* Add your inputs and button for Create operation */}
              <input type="text" placeholder="Product Name" required className="mb-2 p-2 border rounded" />
              <input type="number" placeholder="Quantity" required className="mb-2 p-2 border rounded" />
              <input type="number" placeholder="Price" required className="mb-2 p-2 border rounded" />
        ...
        {activeTab === 1 && (
          <div>
            <h2>Read</h2>
            {/* Add your inputs and button for Read operation */}
            <input type="text" placeholder="Search by Product Name" className="mb-2 p-2 border rounded" />
        ...
        {activeTab === 2 && (
          <div>
            <h2>Update</h2>
            <form>
              {/* Add your inputs and button for Update operation */}
              <input type="number" placeholder="Product ID" required className="mb-2 p-2 border rounded" />
              <input type="text" placeholder="New Product Name" className="mb-2 p-2 border rounded" />
              <input type="number" placeholder="New Quantity" className="mb-2 p-2 border rounded" />
              <input type="number" placeholder="New Price" className="mb-2 p-2 border rounded" />
        ...
        {activeTab === 3 && (
          <div>
            <h2>Delete</h2>
            <form>
              {/* Add your inputs and button for Delete operation */}
              <input type="number" placeholder="Product ID" required className="mb-2 p-2 border rounded" />
